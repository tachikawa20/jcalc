...
string MSG07_NUMTOOLONG = "Number too long";
...
string DC001_PRCVTTOOLS = "cvt [type1] [type2] [x] -> Convert between numeral systems. Types include 'hex' for Hexadecimal, 'dec' for Decimal, 'oct' for Octal and 'bin' for Binary";

string VER00_AUTHORWHAT = "by tachikawa20";
string VER01_LICENSEWHO = "Protected by GPL v3 license.";
string VER02_RELEASEDAT = "2020/11";
string VER03_MOTTOABOUT = "Aiming for maximum compatibility. Always.";
